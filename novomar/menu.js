...
document.write ('<option value="">Selecione o autor');
...
document.write ('<option value="alencar/index.htm">Alencar, Heron de');
document.write ('<option value="alessio/index.htm">Alessio, Aldo d');
document.write ('<option value="alia/index.htm">Alia, Ramiz');
document.write ('<option value="allem-james/index.htm">Allen, James S.');
...
document.write ('<option value="alpatov/index.htm">Alpatov, Mikhail Vladimirovich');
...
document.write ('<option value="arshinov/index.htm">Arshinov, Piotr Andreyevich');
...
document.write ('<option value="bordiga/index.htm">Bordiga, Amadeu');
...
document.write ('<option value="bukharin/index.htm">Bukharine, Nikolai');
...
document.write ('<option value="burns/index.htm">Burnsa, Emile');
...
document.write ('<option value="chen-po-ta/index.htm">Chen Po-ta');
document.write ('<option value="chen_yun/index.htm">Chen Yun');
document.write ('<option value="chtemenko/index.htm">Chtemenko, Serguei Matvéievitch');
document.write ('<option value="chu-en-lai/index.htm">Chu En-Lai');
...
document.write ('<option value="davydov/index.htm">Davydov, Vasili Vasilievich');
...
document.write ('<option value="dune/index.htm">Dune, Eduard Martynovich');
...
document.write ('<option value="etievant/index.htm">Etiévant, Claude-François Georges');
...
document.write ('<option value="gomulka/index.htm">Gomulka, Wladyslaw');
...
document.write ('<option value="ilyenkov/index.htm">Ilyenkov, Evald Vasilyevich');
...
document.write ('<option value="joffe/index.htm">Joffe, Adolf');
...
document.write ('<option value="kalinin/index.htm">Kalinin, Mikhail Ivanovich');
document.write ('<option value="kant/index.htm">Kant, Immanuel');
document.write ('<option value="kapitonovich/index.htm">Kapitonovich, Luppol Ivan');
...
document.write ('<option value="kolman/index.htm">Kolman, Ernest');
...
document.write ('<option value="krupskaia/index.htm">Krupskaia, Nadezda');
document.write ('<option value="kurz/index.htm">Kurz, Robert');
document.write ('<option value="kuusinen/index.htm">Kuusinen, Otto');
document.write ('<option value="labica/index.htm">Labica, George');
...
document.write ('<option value="lapidus/index.htm">Lapidus, Iosif Abramovich');
...
document.write ('<option value="lozovski/index.htm">Lozovski, Solomon');
...
document.write ('<option value="lunatcharski/index.htm">Lunacharsky, Anatoli Vassilievitch');
document.write ('<option value="luria/index.htm">Luria, Alexander Romanovich');
document.write ('<option value="luso/index.htm">Luso Soares, Fernando');
document.write ('<option value="luxemburgo/index.htm">Luxemburg, Rosa');
...
document.write ('<option value="maksimovski/index.htm">Maksimóvski, Vladímir Nikoláevich');
...
document.write ('<option value="manfred/index.htm">Manfred, Albert Zakharovich');
...
document.write ('<option value="eleanor/index.htm">Marx, Eleanor Aveling');
document.write ('<option value="jenny/index.htm">Marx, Jenny von Westphalen');
...
document.write ('<option value="maximoff/index.htm">Maximoff, Grigori Petrovich');
document.write ('<option value="mayakovsky/index.htm">Mayakovsky, Vladimir');
document.write ('<option value="mazundar/index.htm">Mazundar, Charu');
...
document.write ('<option value="mikhailov/index.htm">Mikhailov, Nikolai Alexandrovich');
...
document.write ('<option value="ostrovitianov/index.htm">Ostrovitianov, Konstantín Vasilievich');
...
document.write ('<option value="pavlov/index.htm">Pavlov, Ivan Petrovich');
...
document.write ('<option value="preobrazhensky/index.htm">Preobrazhensky, Alexeyevich Evgeni');
...
document.write ('<option value="rubinstein/index.htm">Rubinstein, Serguei Leonidovich');
document.write ('<option value="ruhle/index.htm">Ruhle, Otto');
...
document.write ('<option value="sapronov/index.htm">Saprónov, Timofei Vladímirovitch');
...
document.write ('<option value="shepilov/index.htm">Shepilov, Dmitri Trofimovich');
...
document.write ('<option value="sultan-galiev/index.htm">Sultan-Galiev, Mirsaid Khaidargalievich');
...
document.write ('<option value="ta/index.htm">Thau, Ta Thu');
document.write ('<option value="tchakhotine/index.htm">Tchakhotine, Sergei Stepanovich');
...
document.write ('<option value="trachtenberg/index.htm">Trachtenberg, Orest Vladimirovich');
...
document.write ('<option value="trotsky/index.htm">Trotsky, Leão');
document.write ('<option value="truong-chinh/index.htm">Trường Chinh');
document.write ('<option value="sedova/index.htm">Trotsky, Natalia');
document.write ('<option value="varga/index.htm">Varga, Eugène');
...
document.write ('<option value="wright/index.htm">Wright, John G. (Joseph Vanzler)');
document.write ('<option value="yakovlev/index.htm">Yakovlev, Nikolai Nikoláievitch');
document.write ('<option value="yanovskaya/index.htm">Yanovskaya, Sofya Aleksandrovna');
...
document.write ('<option value="zinoviev-alexandr/index.htm">Zinóviev, Aleksandr Aleksándrovitch');
document.write ('<option value="zinoviev/index.htm">Zinoviev, Grigori');
document.write ('<option value="zo-daxa/index.htm">Zo dAxa');

document.write ('</select>');
document.write ('</form></td></tr><tr><td align=left>');
document.write ('<form><select name="select1" onChange="selectaplace(this.form)" size=1>');
document.write ('<option value="">ou selecione a seção');
document.write ('<option value="biblioteca.htm">Biblioteca');
document.write ('<option value="dicionario/index.htm">Dicionário');
document.write ('<option value="tematica/index.htm">Temas:');
document.write ('<option value="tematica/album_fotos/index.htm">Album de Imagens');
...
document.write ('<option value="tematica/livros/frelimo/index.htm">Documentos da Frelimo');
...
document.write ('<option value="tematica/mulher.htm">Marxismo a Mulher');
...
document.write ('<option value="admin/index.htm">Quem Somos');
